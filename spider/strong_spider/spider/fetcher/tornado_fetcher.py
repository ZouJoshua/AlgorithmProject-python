...
from spider.tools import utils, dataurl, counter
from spider.tools.url import quote_chinese
...
class Fetcher(object):
    user_agent = "pyspider/%s (+http://pyspider.org/)" % spider.__version__
    default_options = {
        'method': 'GET',
        'headers': {
        },
    ...
    def send_result(self, type, task, result):
        '''Send fetch result to processer'''
        if self.outqueue:
            try:
