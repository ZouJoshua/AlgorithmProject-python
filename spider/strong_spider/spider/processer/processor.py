...
from spider.tools.log import LogFormatter
from spider.tools.utils import pretty_unicode, hide_me
...
class Processor(object):
    ...
    def run(self):
        '''Run loop'''
        logger.info("processer starting...")
