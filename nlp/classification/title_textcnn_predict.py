...
import os
import codecs
from title_textcnn_model import TextCNN
...
tf.app.flags.DEFINE_string("ckpt_dir", "data/caifuli/news_classification/textcnn/textcnn_title_checkpoint/", "checkpoint location for the model")
...
tf.app.flags.DEFINE_string("predict_target_file", "data/news_classification/textcnn/textcnn_title_checkpoint/predict_target", "target file path for final prediction")
tf.app.flags.DEFINE_string("predict_source_file", 'data/news_classification/textcnn/textcnn_title_checkpoint/predict_source', "target file path for final prediction")
...
title_word_vector_path = "data/caifului/news_classification/preprocess/title_word_vector.bin"
model_path = "data/caifului/news_classification/preprocess/word2vec_model"
