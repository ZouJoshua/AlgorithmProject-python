...
@Author  : Joshua
@Time    : 19-5-27 下午5:30
@File    : train_emotion_category.py
@Desc    : 训练英语情感分析分类
"""
...
class EmotionCategoryModel(object):

    def __init__(self, dataDir, category='emotion', k=5, model_level='emotion'):
