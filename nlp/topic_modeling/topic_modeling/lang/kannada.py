...
class Kannada:
    ...
    def load_stop_words(self):
        stop_word_list = []
        f_obj = open('topic_modeling/stopwords/kannada_stop_words.txt', 'r')
    ...
    def tokenize(self, text):
        ...
        kannada_stop_words = self.load_stop_words()

        for word in tokenize_text:

            # steming
            w = Word(word, language="kn")
